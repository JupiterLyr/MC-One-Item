...
execute unless data entity @s Inventory[{Slot:9b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s inventory.0 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:10b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s inventory.1 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:11b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s inventory.2 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:12b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s inventory.3 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:13b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s inventory.4 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:14b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s inventory.5 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:15b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s inventory.6 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:16b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s inventory.7 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:17b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s inventory.8 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:18b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s inventory.9 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:19b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s inventory.10 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:20b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s inventory.11 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:21b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s inventory.12 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:22b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s inventory.13 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:23b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s inventory.14 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:24b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s inventory.15 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:25b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s inventory.16 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:26b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s inventory.17 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:27b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s inventory.18 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:28b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s inventory.19 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:29b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s inventory.20 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:30b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s inventory.21 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:31b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s inventory.22 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:32b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s inventory.23 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:33b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s inventory.24 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:34b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s inventory.25 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:35b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s inventory.26 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:0b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s hotbar.0 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:1b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s hotbar.1 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:2b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s hotbar.2 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:3b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s hotbar.3 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:5b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s hotbar.5 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:6b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s hotbar.6 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:7b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s hotbar.7 with minecraft:barrier{slotlock_blocked:1b}
...
execute unless data entity @s Inventory[{Slot:8b,id:"minecraft:barrier",tag:{slotlock_blocked:1b}}] run item replace entity @s hotbar.8 with minecraft:barrier{slotlock_blocked:1b}
