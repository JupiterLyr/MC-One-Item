...
execute at @s run data modify entity @e[type=item,tag=slotlock_recovery,sort=nearest,limit=1] Item set from storage slotlock:recovery item
execute at @s run tag @e[type=item,tag=slotlock_recovery,sort=nearest,limit=1] remove slotlock_recovery
