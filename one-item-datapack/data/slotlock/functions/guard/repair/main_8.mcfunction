...
item replace entity @s inventory.8 with minecraft:barrier{CustomModelData:1,slotlock_blocked:1b,CanPlaceOn:[],slotlock_slot:17,display:{Name:'{"text":" ","italic":false}'}}
