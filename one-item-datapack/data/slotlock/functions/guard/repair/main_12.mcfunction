...
item replace entity @s inventory.12 with minecraft:barrier{CustomModelData:1,slotlock_blocked:1b,CanPlaceOn:[],slotlock_slot:21,display:{Name:'{"text":" ","italic":false}'}}
