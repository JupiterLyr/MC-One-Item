...
item replace entity @s inventory.12 with minecraft:knowledge_book{CustomModelData:1,slotlock_blocked:1b,slotlock_slot:21,display:{Name:'{"text":" ","italic":false}'}}
