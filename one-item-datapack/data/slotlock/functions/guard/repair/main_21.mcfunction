...
item replace entity @s inventory.21 with minecraft:knowledge_book{CustomModelData:1,slotlock_blocked:1b,slotlock_slot:30,display:{Name:'{"text":" ","italic":false}'}}
