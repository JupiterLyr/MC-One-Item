...
item replace entity @s inventory.21 with minecraft:barrier{CustomModelData:1,slotlock_blocked:1b,CanPlaceOn:[],slotlock_slot:30,display:{Name:'{"text":" ","italic":false}'}}
