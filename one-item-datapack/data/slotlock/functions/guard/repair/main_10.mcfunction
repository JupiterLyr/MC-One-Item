...
item replace entity @s inventory.10 with minecraft:barrier{CustomModelData:1,slotlock_blocked:1b,CanPlaceOn:[],slotlock_slot:19,display:{Name:'{"text":" ","italic":false}'}}
