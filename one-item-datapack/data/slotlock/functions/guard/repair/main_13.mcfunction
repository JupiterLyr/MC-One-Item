...
item replace entity @s inventory.13 with minecraft:barrier{CustomModelData:1,slotlock_blocked:1b,CanPlaceOn:[],slotlock_slot:22,display:{Name:'{"text":" ","italic":false}'}}
