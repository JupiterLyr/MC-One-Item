...
item replace entity @s inventory.17 with minecraft:knowledge_book{CustomModelData:1,slotlock_blocked:1b,slotlock_slot:26,display:{Name:'{"text":" ","italic":false}'}}
