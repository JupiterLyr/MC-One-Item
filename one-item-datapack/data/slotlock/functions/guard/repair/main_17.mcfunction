...
item replace entity @s inventory.17 with minecraft:barrier{CustomModelData:1,slotlock_blocked:1b,CanPlaceOn:[],slotlock_slot:26,display:{Name:'{"text":" ","italic":false}'}}
