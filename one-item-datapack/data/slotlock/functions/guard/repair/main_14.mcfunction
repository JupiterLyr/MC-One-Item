...
item replace entity @s inventory.14 with minecraft:knowledge_book{CustomModelData:1,slotlock_blocked:1b,slotlock_slot:23,display:{Name:'{"text":" ","italic":false}'}}
