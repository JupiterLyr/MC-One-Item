...
item replace entity @s inventory.18 with minecraft:knowledge_book{CustomModelData:1,slotlock_blocked:1b,slotlock_slot:27,display:{Name:'{"text":" ","italic":false}'}}
