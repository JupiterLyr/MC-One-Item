...
item replace entity @s inventory.18 with minecraft:barrier{CustomModelData:1,slotlock_blocked:1b,CanPlaceOn:[],slotlock_slot:27,display:{Name:'{"text":" ","italic":false}'}}
