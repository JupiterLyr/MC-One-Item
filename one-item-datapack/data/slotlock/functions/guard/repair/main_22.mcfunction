...
item replace entity @s inventory.22 with minecraft:knowledge_book{CustomModelData:1,slotlock_blocked:1b,slotlock_slot:31,display:{Name:'{"text":" ","italic":false}'}}
