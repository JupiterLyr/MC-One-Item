...
item replace entity @s inventory.22 with minecraft:barrier{CustomModelData:1,slotlock_blocked:1b,CanPlaceOn:[],slotlock_slot:31,display:{Name:'{"text":" ","italic":false}'}}
