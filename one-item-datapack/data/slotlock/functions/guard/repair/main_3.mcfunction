...
item replace entity @s inventory.3 with minecraft:barrier{CustomModelData:1,slotlock_blocked:1b,CanPlaceOn:[],slotlock_slot:12,display:{Name:'{"text":" ","italic":false}'}}
