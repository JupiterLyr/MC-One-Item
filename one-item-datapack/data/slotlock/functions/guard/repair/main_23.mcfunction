...
item replace entity @s inventory.23 with minecraft:knowledge_book{CustomModelData:1,slotlock_blocked:1b,slotlock_slot:32,display:{Name:'{"text":" ","italic":false}'}}
