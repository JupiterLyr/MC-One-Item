...
item replace entity @s inventory.23 with minecraft:barrier{CustomModelData:1,slotlock_blocked:1b,CanPlaceOn:[],slotlock_slot:32,display:{Name:'{"text":" ","italic":false}'}}
