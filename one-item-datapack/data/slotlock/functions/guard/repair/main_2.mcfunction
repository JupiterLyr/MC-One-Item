...
item replace entity @s inventory.2 with minecraft:barrier{CustomModelData:1,slotlock_blocked:1b,CanPlaceOn:[],slotlock_slot:11,display:{Name:'{"text":" ","italic":false}'}}
