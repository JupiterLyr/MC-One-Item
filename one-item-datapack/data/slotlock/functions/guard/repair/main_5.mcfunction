...
item replace entity @s inventory.5 with minecraft:barrier{CustomModelData:1,slotlock_blocked:1b,CanPlaceOn:[],slotlock_slot:14,display:{Name:'{"text":" ","italic":false}'}}
