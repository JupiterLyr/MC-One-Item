...
item replace entity @s inventory.20 with minecraft:knowledge_book{CustomModelData:1,slotlock_blocked:1b,slotlock_slot:29,display:{Name:'{"text":" ","italic":false}'}}
