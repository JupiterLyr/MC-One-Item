...
item replace entity @s inventory.26 with minecraft:barrier{CustomModelData:1,slotlock_blocked:1b,CanPlaceOn:[],slotlock_slot:35,display:{Name:'{"text":" ","italic":false}'}}
