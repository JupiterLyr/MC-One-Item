...
item replace entity @s inventory.26 with minecraft:knowledge_book{CustomModelData:1,slotlock_blocked:1b,slotlock_slot:35,display:{Name:'{"text":" ","italic":false}'}}
