...
item replace entity @s inventory.25 with minecraft:knowledge_book{CustomModelData:1,slotlock_blocked:1b,slotlock_slot:34,display:{Name:'{"text":" ","italic":false}'}}
