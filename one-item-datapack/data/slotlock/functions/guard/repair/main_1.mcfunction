...
item replace entity @s inventory.1 with minecraft:barrier{CustomModelData:1,slotlock_blocked:1b,CanPlaceOn:[],slotlock_slot:10,display:{Name:'{"text":" ","italic":false}'}}
