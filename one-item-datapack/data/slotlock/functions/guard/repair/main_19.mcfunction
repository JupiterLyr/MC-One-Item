...
item replace entity @s inventory.19 with minecraft:barrier{CustomModelData:1,slotlock_blocked:1b,CanPlaceOn:[],slotlock_slot:28,display:{Name:'{"text":" ","italic":false}'}}
