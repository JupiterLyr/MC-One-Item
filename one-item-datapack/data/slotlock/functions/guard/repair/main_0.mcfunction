...
item replace entity @s inventory.0 with minecraft:barrier{CustomModelData:1,slotlock_blocked:1b,CanPlaceOn:[],slotlock_slot:9,display:{Name:'{"text":" ","italic":false}'}}
