...
item replace entity @s inventory.15 with minecraft:knowledge_book{CustomModelData:1,slotlock_blocked:1b,slotlock_slot:24,display:{Name:'{"text":" ","italic":false}'}}
