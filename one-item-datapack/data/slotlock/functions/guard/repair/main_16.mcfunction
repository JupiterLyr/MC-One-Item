...
item replace entity @s inventory.16 with minecraft:knowledge_book{CustomModelData:1,slotlock_blocked:1b,slotlock_slot:25,display:{Name:'{"text":" ","italic":false}'}}
