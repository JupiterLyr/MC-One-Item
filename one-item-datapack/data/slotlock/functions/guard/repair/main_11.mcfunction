...
item replace entity @s inventory.11 with minecraft:knowledge_book{CustomModelData:1,slotlock_blocked:1b,slotlock_slot:20,display:{Name:'{"text":" ","italic":false}'}}
