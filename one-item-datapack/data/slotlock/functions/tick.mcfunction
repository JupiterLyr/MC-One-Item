...
# Watch nearby dropped marked barriers briefly after inventory activity.
execute as @a[scores={slotlock_drop_watch=1..}] at @s run kill @e[type=item,distance=..8,nbt={Item:{id:"minecraft:barrier",tag:{slotlock_blocked:1b}}}]
